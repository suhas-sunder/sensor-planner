...
const CanvasArea: React.FC<CanvasAreaProps> = ({ devices, selectedDeviceId, onCanvasClick, viewport, setViewport }) => {
...
//   // Set actual drawing buffer to match CSS size
   ...
   <div className='flex w-full h-screen bg-black'>
    <div className='flex flex-col w-60 items-center bg-slate-600 gap-5 text-white'>
      ...
      <div className='flex flex-col gap-3 border-2 border-white rounded-md p-2 px-4'>
        ...
        <div className='w-40 h-40 bg-slate-400 rounded-md'>SENSOR PREVIEW IMG</div>
      ...
      <div className='flex flex-col gap-8 mt-auto -translate-y-25'>
       ...
       <button className='border-2 border-white rounded-md p-2'>Add Sensor</button>
        <button className='border-2 border-white rounded-md p-2'>Add Device</button>
      </div>
    </div>
     <CanvasArea
      devices={devices}
